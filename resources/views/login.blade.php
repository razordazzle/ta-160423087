...
<body>
    ...
    <div class="max-w-md mx-auto px-6 pt-6 pb-10">
        ...
        <div class="relative flex items-center">
            ...
            <span class="absolute inset-x-0 text-center text-xs font-bold tracking-widest uppercase text-gray-500">Login</span>
        </div>

        {{-- Header --}}
        <h1 class="mt-6 text-[28px] leading-tight font-heading font-bold text-gray-900">Masuk ke Akun</h1>
        <p class="text-gray-600 text-[15px] mt-2 leading-relaxed">Masuk untuk mengakses preferensi dan wishlist yang telah tersimpan di akun Anda.</p>
        ...
        <form method="POST" action="{{ route('login.store') }}" class="mt-6">
            ...
            <button type="submit" class="mt-8 w-full bg-primary text-white font-bold text-[15px] rounded-full py-4 shadow-lg shadow-primary/20">Masuk</button>
        </form>

        <p class="mt-5 text-center text-sm text-gray-600">Belum punya akun? <a href="{{ route('registrasi.form') }}" class="text-secondary font-semibold">Daftar</a></p>
    </div>
